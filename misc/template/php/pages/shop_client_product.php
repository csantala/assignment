<!-- Filters -->
<div class="filter-bar margin-bottom-none border-top-none">
	<form>
		<div>
...
<h3><?php echo $translate->_('online_shop'); ?></h3>
<div class="innerLR">
		...
		<div class="widget-body">
			<div class="tab-content">
				...
				<div class="tab-pane active" id="reviewsTab">
					...
					<!-- Media item -->
					<div class="media">
						<img class="media-object pull-left thumb" src="http://dummyimage.com/51x51/232323/ffffff&amp;text=photo" alt="">
