...
<?php if ($page != 'login' && $page != 'signup' && $page != 'error' && $page != 'choose'): ?>	
		...
		<div id="footer" class="hidden-print">
			...
			<!--  Copyright Line -->
			<div class="copy">&copy; 2012 - <?php echo date('Y'); ?> - <a href="http://www.mosaicpro.biz">MosaicPro</a> - All Rights Reserved. <a href="http://themeforest.net/item/ergo-admin-ui-template/4602755?ref=mosaicpro" target="_blank">Purchase <?php echo APP_NAME; ?> on ThemeForest</a> - Current version: <?php echo APP_VERSION; ?> / <a target="_blank" href="http://demo.mosaicpro.biz/ergoadmin/CHANGELOG">changelog</a></div>
			<!--  End Copyright Line -->
