...
$autoload['libraries'] = array('database', 'Tracker_lib', 'Browser', 'session', 'simpleloginsecure', 'pagination');
...
$autoload['helper'] = array('General_helper', 'url', 'cookie', 'Hashids_helper');
